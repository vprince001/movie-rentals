...
public class CustomerTest extends TestCase {
    ...
    private Movie python = new Movie("Monty Python and the Holy Grail", MovieDetails.REGULAR);
    private Movie ran = new Movie("Ran", MovieDetails.REGULAR);
    private Movie la = new Movie("LA Confidential", MovieDetails.NEW_RELEASE);
    private Movie trek = new Movie("Star Trek 13.2", MovieDetails.NEW_RELEASE);
    private Movie wallace = new Movie("Wallace and Gromit", MovieDetails.CHILDREN);
    ...
    public void testChange() throws Exception {
        la.setMovieDetails(MovieDetails.REGULAR);
